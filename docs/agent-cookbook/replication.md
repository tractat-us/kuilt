...
content-addressed WebAssembly kernel shipped through [Code mobility](../agent-cookbook.md#code-mobility), and
...
The primitive lives in the warp family; see `warp.md` for where a task may run and how code travels.
