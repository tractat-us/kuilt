...
`../kuilt`.) The skill routes to the `docs/agent-cookbook.md` index and its family files
(`docs/agent-cookbook/<family>.md`), a symptom→primitive lookup for reconnect, replicated
state, liveness, consensus, and dedup.
