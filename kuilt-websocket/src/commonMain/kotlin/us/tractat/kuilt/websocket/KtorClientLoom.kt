...
public class KtorClientLoom(
    ...
    /**
     * Not meaningful for a client — clients join existing sessions, they do not
     * create them. Throws [UnsupportedOperationException].
     */
    ...
    /**
     * Connects to the WebSocket URL in [advertisement] and returns a 2-peer
     * [Seam] ready for use.
     *
     * @throws IllegalArgumentException if [advertisement] is not a [WebSocketAdvertisement].
     */
