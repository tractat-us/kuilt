 ...
 * @see DraftStage
 */
public class Draft<out T>
/**
 * The constructor is `public` because the extracted `:kuilt-warp-planning` rewrites
 * reconstruct [Draft] graphs directly from transformed [DraftNode] lists (and [Warp.shuttle]
 * already constructs via it).
 */
public constructor(
     ...
     * The `optimize` rewrite (in `:kuilt-warp-planning`) applies branch-aware optimisation per branch.
     */
