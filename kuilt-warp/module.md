...
planner never drags in the ML demo. The heavy weight (the wasm3 native binaries, the runtime
engines) stays out of the way of a peer that just dispatches work.
