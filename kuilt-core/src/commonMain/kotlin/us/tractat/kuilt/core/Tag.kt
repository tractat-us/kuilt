 ...
 * their own implementations (e.g. `WebSocketTag` in `:transport-websocket`,
 * `MDNSTag` in a future `:transport-mdns`). Sealed would confine all
 * tag types to `:transport-core`, defeating the extensibility goal.
 *
