...
import kotlinx.coroutines.Dispatchers // ALLOW-realDispatcher: real OS-thread concurrency stress harness — needs Dispatchers.Default/IO for genuine parallelism probes
