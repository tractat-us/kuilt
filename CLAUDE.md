...
- **Build logic is centralized** in `build-logic/`: `kuilt.kmp-library` defines
  ...
  lint wiring: there is no linter, and the root build's guards are source scans
