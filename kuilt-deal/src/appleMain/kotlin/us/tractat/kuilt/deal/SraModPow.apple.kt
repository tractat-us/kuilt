...
/**
 * iOS/macOS path: no native arbitrary-precision integer, so use the pure-Kotlin
 * ionspin/bignum implementation. Same algorithm and output as the original common
 * code; the result is canonicalized by [sraModPowCanonical].
 */
