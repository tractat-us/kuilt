...
// build.gradle.kts
dependencies {
    implementation(platform("us.tractat.kuilt:kuilt-bom:0.4.0-rc3"))
...
dependencies {
    implementation("us.tractat.kuilt:kuilt-core:0.4.0-rc3")
    implementation("us.tractat.kuilt:kuilt-websocket:0.4.0-rc3")
}
```
