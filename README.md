...
// build.gradle.kts
dependencies {
    implementation(platform("us.tractat.kuilt:kuilt-bom:0.5.0-rc1"))
...
dependencies {
    implementation("us.tractat.kuilt:kuilt-core:0.5.0-rc1")
    implementation("us.tractat.kuilt:kuilt-websocket:0.5.0-rc1")
}
```
