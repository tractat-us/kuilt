...
// build.gradle.kts
dependencies {
    implementation(platform("us.tractat.kuilt:kuilt-bom:0.7.0"))
...
dependencies {
    implementation("us.tractat.kuilt:kuilt-core:0.7.0")
    implementation("us.tractat.kuilt:kuilt-websocket:0.7.0")
}
```

Replace `0.7.0` with the [latest release](https://central.sonatype.com/artifact/us.tractat.kuilt/kuilt-core).
