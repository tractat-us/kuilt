...
// build.gradle.kts
dependencies {
    implementation(platform("us.tractat.kuilt:kuilt-bom:0.6.0"))
...
dependencies {
    implementation("us.tractat.kuilt:kuilt-core:0.6.0")
    implementation("us.tractat.kuilt:kuilt-websocket:0.6.0")
}
```
