@file:Suppress("ForbiddenImport") // real-network loopback harness — a real Network.framework socket needs a real IO dispatcher; no virtual-time option exists here
